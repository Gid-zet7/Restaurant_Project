...
const contact = () => {
  ...
  lockupDiv.innerHTML = `
        <img src="/blob/main/src/Images/fullLockupColor.svg" alt="">
        <hr>
        <h1>Grab a Bite</h1>
    `;
...
const createNavbar = () => {
  ...
  logoContainer.innerHTML = ` <img src="/blob/main/src/Images/fullLockup.svg " alt="">`;
