...
const contact = () => {
  ...
  lockupDiv.innerHTML = `
        <img src="../src/Images/Full-Lockup-Color.SVG" alt="">
        <hr>
        <h1>Grab a Bite</h1>
    `;
...
const createNavbar = () => {
  ...
  logoContainer.innerHTML = ` <img src="../src/Images/Full-Lockup-Black.SVG" alt="">`;
